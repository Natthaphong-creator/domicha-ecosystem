...
- สมัครสมาชิก/เข้าสู่ระบบ/ออกจากระบบด้วย Supabase Auth
- role ผู้ใช้: Admin, Sales, Accountant
...
- หน้าร้านลูกค้า `/shop`: เลือกสินค้า ตะกร้า Checkout และแจ้งออเดอร์เข้า LINE OA
- CRUD ลูกค้า
- CRUD ซัพพลายเออร์
...
## ตั้งค่ารับออเดอร์จากหน้าร้านผ่าน LINE OA

หน้าร้านลูกค้าเปิดที่ `/shop` โดยไม่ต้องเข้าสู่ระบบ เมื่อยืนยันออเดอร์ API จะตรวจสินค้าและคำนวณยอดใหม่จากราคาฝั่งเซิร์ฟเวอร์ก่อนส่ง Flex Message เข้า LINE OA
...
`LINE_OA_ORDER_TARGET_ID` คือ User ID, Group ID หรือ Room ID ที่บอตมีสิทธิ์ส่งข้อความถึง หากยังไม่ตั้งค่าสองค่านี้ ระบบจะรับออเดอร์ในโหมดตัวอย่างและแสดงเลขที่ออเดอร์ แต่จะไม่เรียก LINE API
